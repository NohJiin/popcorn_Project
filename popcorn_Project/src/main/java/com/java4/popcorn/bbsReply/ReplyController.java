...
public class ReplyController {
	...
	public List<ReplyVO> list(@RequestParam("b_comment_id") int b_comment_id, Model model) {
	    System.out.println(b_comment_id);
	    System.out.println("list 요청됨.");
	    System.out.println(dao);
	    try {
	        List<ReplyVO> list = dao.getReplyList(b_comment_id);
    ...
    public void insertComment(@RequestParam("content") String content, @RequestParam("b_comment_id") int b_comment_id, @RequestParam("bbs_no") int bbs_no, HttpServletRequest request, ReplyVO vo, Model model) {
		 // 사용자 아이디 가져오기
		...
		List<ReplyVO> list2 = dao.getReplyList(vo.getB_comment_id());
